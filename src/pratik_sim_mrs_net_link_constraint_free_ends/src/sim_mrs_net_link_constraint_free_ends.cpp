...
#include <pratik_sim_mrs_net_link_constraint_free_ends/sim_mrs_net_link_constraint_free_endsConfig.h>
...
/* class PratikSimMrsNetLinkConstraintFreeEnds //{ */

class PratikSimMrsNetLinkConstraintFreeEnds : public nodelet::Nodelet {
...
private:
  ...
  typedef pratik_sim_mrs_net_link_constraint_free_ends::sim_mrs_net_link_constraint_free_endsConfig DrsConfig_t;
  typedef dynamic_reconfigure::Server<DrsConfig_t>             Drs_t;
  boost::shared_ptr<Drs_t>                                     drs_;
  void                                                         callbackDrs(pratik_sim_mrs_net_link_constraint_free_ends::sim_mrs_net_link_constraint_free_endsConfig& config, uint32_t level);
...
void PratikSimMrsNetLinkConstraintFreeEnds::onInit() {
  ...
  mrs_lib::ParamLoader param_loader(nh_, "PratikSimMrsNetLinkConstraintFreeEnds");
  ...
  for (size_t i = 0; i < uav_names.size(); i++) {
    ...
    ROS_INFO("[PratikSimMrsNetLinkConstraintFreeEnds]: initializing '%s'", uav_name.c_str());
  ...
  Drs_t::CallbackType f = boost::bind(&PratikSimMrsNetLinkConstraintFreeEnds::callbackDrs, this, _1, _2);
  drs_->setCallback(f);

  if (!param_loader.loadedSuccessfully()) {
    ROS_ERROR("[PratikSimMrsNetLinkConstraintFreeEnds]: could not load all parameters!");
    ros::shutdown();
  }
  ...
  timer_main_ = nh_.createWallTimer(ros::WallDuration(1.0 / (_simulation_rate_ * drs_params_.realtime_factor)), &PratikSimMrsNetLinkConstraintFreeEnds::timerMain, this);

  timer_status_ = nh_.createWallTimer(ros::WallDuration(1.0), &PratikSimMrsNetLinkConstraintFreeEnds::timerStatus, this);

  // | ----------------------- finish init ---------------------- |

  is_initialized_ = true;

  ROS_INFO("[PratikSimMrsNetLinkConstraintFreeEnds]: initialized");
}
...
void PratikSimMrsNetLinkConstraintFreeEnds::timerMain([[maybe_unused]] const ros::WallTimerEvent& event) {

  if (!is_initialized_) {
    return;
  }

  ROS_INFO_ONCE("[PratikSimMrsNetLinkConstraintFreeEnds]: main timer spinning");
...
void PratikSimMrsNetLinkConstraintFreeEnds::timerStatus([[maybe_unused]] const ros::WallTimerEvent& event) {
  ...
  ROS_INFO_THROTTLE(0.1, "[PratikSimMrsNetLinkConstraintFreeEnds]: %s, desired RTF = %.2f, actual RTF = %.2f", drs_params.paused ? "paused" : "running",
...
void PratikSimMrsNetLinkConstraintFreeEnds::callbackDrs(pratik_sim_mrs_net_link_constraint_free_ends::sim_mrs_net_link_constraint_free_endsConfig& config, [[maybe_unused]] uint32_t level) {
  ...
  ROS_INFO("[PratikSimMrsNetLinkConstraintFreeEnds]: DRS updated params");
}
...
void PratikSimMrsNetLinkConstraintFreeEnds::handleCollisions(void) {
...
void PratikSimMrsNetLinkConstraintFreeEnds::publishPoses(void) {
...
PLUGINLIB_EXPORT_CLASS(pratik_sim_mrs_net_link_constraint_free_ends::PratikSimMrsNetLinkConstraintFreeEnds, nodelet::Nodelet)
