...
#include <pratik_controller_mrs_net_free_ends/controller_mrs_net_free_endsConfig.h>
...
namespace pratik_controller_mrs_net_free_ends
{

namespace controller_mrs_net_free_ends
{
...
/* //{ class ControllerMrsNetFreeEnds */

class ControllerMrsNetFreeEnds : public mrs_uav_managers::Controller {
...
private:
  ...
  typedef pratik_controller_mrs_net_free_ends::controller_mrs_net_free_endsConfig DrsConfig_t;
  typedef dynamic_reconfigure::Server<DrsConfig_t>            Drs_t;
  boost::shared_ptr<Drs_t>                                    drs_;
  void                                                        callbackDrs(pratik_controller_mrs_net_free_ends::controller_mrs_net_free_endsConfig& config, uint32_t level);
...
bool ControllerMrsNetFreeEnds::initialize(const ros::NodeHandle& nh, std::shared_ptr<mrs_uav_managers::control_manager::CommonHandlers_t> common_handlers,
                                   std::shared_ptr<mrs_uav_managers::control_manager::PrivateHandlers_t> private_handlers) {
  ...
  success *= private_handlers->loadConfigFile(ros::package::getPath("pratik_controller_mrs_net_free_ends") + "/config/controller_mrs_net_free_ends.yaml");

  if (!success) {
    return false;
  }

  mrs_lib::ParamLoader param_loader(nh_, "ControllerMrsNetFreeEnds");

  const std::string yaml_namespace = "pratik_controller_mrs_net_free_ends/default_gains/";
  ...
  // gain filtering
  const std::string yaml_namespace_gain = "pratik_controller_mrs_net_free_ends/gain_filtering/";
  ...
  const std::string yaml_namespace_ang_rate_ff = "pratik_controller_mrs_net_free_ends/angular_rate_feedforward/";
  ...
  // constraints
  private_handlers->param_loader->loadParam("pratik_controller_mrs_net_free_ends/constraints/tilt_angle_failsafe/enabled", _tilt_angle_failsafe_enabled_);
  private_handlers->param_loader->loadParam("pratik_controller_mrs_net_free_ends/constraints/tilt_angle_failsafe/limit", _tilt_angle_failsafe_);
  ...
  if (_tilt_angle_failsafe_enabled_ && std::abs(_tilt_angle_failsafe_) < 1e-3) {
    ROS_ERROR("[ControllerMrsNetFreeEnds]: constraints/tilt_angle_failsafe/enabled = 'TRUE' but the limit is too low");
    return false;
  }
  ...
  if (!param_loader.loadedSuccessfully()) {
    ROS_ERROR("[ControllerMrsNetFreeEnds]: could not load all parameters!");
    return false;
  }
  ...
  Drs_t::CallbackType f = boost::bind(&ControllerMrsNetFreeEnds::callbackDrs, this, _1, _2);
  drs_->setCallback(f);

  // | ------------------------- timers ------------------------- |

  timer_gains_ = nh_.createTimer(ros::Rate(_gain_filtering_rate_), &ControllerMrsNetFreeEnds::timerGains, this, false, false);

  // | ------------------ initialize subscribers ----------------- |

  mrs_lib::SubscribeHandlerOptions shopts;
  shopts.nh                 = nh;
  shopts.node_name          = "ControllerMrsNetFreeEnds";
  ...
  sh_link_states           = mrs_lib::SubscribeHandler<nav_msgs::Odometry>(shopts, "/sim_mrs_net_free_ends/uav1/link_state",
                                                                                            &ControllerMrsNetFreeEnds::callback_link_states, this);
  ...
  ROS_INFO("[ControllerMrsNetFreeEnds]: initialized");
...
bool ControllerMrsNetFreeEnds::activate(const ControlOutput& last_control_output) {
  ...
  if (activation_control_output_.diagnostics.mass_estimator) {
    ...
    ROS_INFO("[ControllerMrsNetFreeEnds]: setting mass difference from the last control output: %.2f kg", uav_mass_difference_);
  }
  ...
  ROS_INFO("[ControllerMrsNetFreeEnds]: activated");
...
void ControllerMrsNetFreeEnds::deactivate(void) {
  ...
  ROS_INFO("[ControllerMrsNetFreeEnds]: deactivated");
}
...
void ControllerMrsNetFreeEnds::updateInactive(const mrs_msgs::UavState& uav_state, [[maybe_unused]] const std::optional<mrs_msgs::TrackerCommand>& tracker_command) {
...
ControllerMrsNetFreeEnds::ControlOutput ControllerMrsNetFreeEnds::updateActive(const mrs_msgs::UavState& uav_state, const mrs_msgs::TrackerCommand& tracker_command) {
  ...
  if (fabs(dt) < 0.001) {
    ...
    ROS_DEBUG("[ControllerMrsNetFreeEnds]: the last odometry message came too close (%.2f s)!", dt);
    dt = 0.01;
    // dt               = 0.004;
  }
  ...
  if (common_handlers_->control_output_modalities.attitude) {
    ROS_INFO_THROTTLE(1.0, "[ControllerMrsNetFreeEnds]: desired attitude output modality is available");
  }
  ...
  if (common_handlers_->detailed_model_params) {
    ...
    // ROS_INFO_STREAM_THROTTLE(1.0, "[ControllerMrsNetFreeEnds]: UAV inertia is: " << detailed_model_params.inertia);
  }
  ...
  if (u_control_input(2) < 0) {
    ROS_WARN_THROTTLE(1.0, "[ControllerMrsNetFreeEnds]: the calculated downwards desired force is negative (%.2f) -> mitigating flip", u_control_input(2));
  ...
  if (tracker_command.use_orientation) {
    ...
    if (tracker_command.use_heading) {
      try {
        ...
        ROS_ERROR_THROTTLE(1.0, "[ControllerMrsNetFreeEnds]: could not set the desired heading");
      }
    }
    ...
    if (tracker_command.use_heading) {
      ...
      ROS_WARN_THROTTLE(10.0, "[ControllerMrsNetFreeEnds]: desired heading was not specified, using current heading instead!");
  ...
  else
  {
    if (desired_thrust_force >= 0) {
      ...
      ROS_WARN_THROTTLE(1.0, "[ControllerMrsNetFreeEnds]: just so you know, the desired throttle force is negative (%.2f)", desired_thrust_force);
    }
  }
  ...
  last_control_output_.diagnostics.controller       = "ControllerMrsNetFreeEnds";
...
Eigen::Vector3d ControllerMrsNetFreeEnds::orientationError(const Eigen::Matrix3d& R, const Eigen::Matrix3d& Rd) {
...
const mrs_msgs::ControllerStatus ControllerMrsNetFreeEnds::getStatus() {
...
void ControllerMrsNetFreeEnds::switchOdometrySource([[maybe_unused]] const mrs_msgs::UavState& new_uav_state) {
}
...
void ControllerMrsNetFreeEnds::resetDisturbanceEstimators(void) {
}
...
const mrs_msgs::DynamicsConstraintsSrvResponse::ConstPtr ControllerMrsNetFreeEnds::setConstraints([
  ...
  ROS_INFO("[ControllerMrsNetFreeEnds]: updating constraints");
...
void ControllerMrsNetFreeEnds::callbackDrs(pratik_controller_mrs_net_free_ends::controller_mrs_net_free_endsConfig& config, [[maybe_unused]] uint32_t level) {

  mrs_lib::set_mutexed(mutex_drs_params_, config, drs_params_);

  ROS_INFO("[ControllerMrsNetFreeEnds]: dynamic reconfigure params updated");
}
...
void ControllerMrsNetFreeEnds::timerGains(const ros::TimerEvent& event) {

  mrs_lib::Routine    profiler_routine = profiler_.createRoutine("timerGains", _gain_filtering_rate_, 1.0, event);
  mrs_lib::ScopeTimer timer = mrs_lib::ScopeTimer("ControllerMrsNetFreeEnds::timerGains", common_handlers_->scope_timer.logger, common_handlers_->scope_timer.enabled);
  ...
  if (updated) {
    ...
    ROS_INFO_THROTTLE(10.0, "[ControllerMrsNetFreeEnds]: gains have been updated");
  }
}
...
std::optional<mrs_msgs::HwApiAttitudeRateCmd> ControllerMrsNetFreeEnds::attitudeController(const mrs_msgs::UavState& uav_state, const mrs_msgs::HwApiAttitudeCmd& reference,
                                                                 const Eigen::Vector3d& ff_rate, const Eigen::Vector3d& rate_saturation,
                                                                 const Eigen::Vector3d& gains, const bool& parasitic_heading_rate_compensation) {
...
void ControllerMrsNetFreeEnds::callback_link_states(const nav_msgs::Odometry::ConstPtr msg) {

  alpha     = msg->pose.pose.position.x;
  alpha_dot = msg->twist.twist.linear.x;
}

float ControllerMrsNetFreeEnds::clipping_angle(float max_value, float current_angle){
...
float ControllerMrsNetFreeEnds::clipping_net_thrust_force(float max_value, float current_thrust){
...
Eigen::Vector3d ControllerMrsNetFreeEnds::clipping_e_x_q(Eigen::Vector3d e_x_q_vector){
...
Eigen::Vector3d ControllerMrsNetFreeEnds::clipping_e_x_q_dot(Eigen::Vector3d e_x_q_dot_vector){
...
float ControllerMrsNetFreeEnds::distance_bt_two_pts(Eigen::Vector3d A, Eigen::Vector3d B){
...
Eigen::Vector3d ControllerMrsNetFreeEnds::Matrix_vector_mul(Eigen::Matrix3d R, Eigen::Vector3d v){
  Eigen::Vector3d mul_vector (R(0,0)*v[0] + R(0,1)*v[1] + R(0,2)*v[2], R(1,0)*v[0] + R(1,1)*v[1] + R(1,2)*v[2],  R(2,0)*v[0] + R(2,1)*v[1] + R(2,2)*v[2]);
  return mul_vector;
}

Eigen::Vector3d ControllerMrsNetFreeEnds::Rotation_matrix_to_Euler_angle(Eigen::Matrix3d R){
...
Eigen::Matrix3d ControllerMrsNetFreeEnds::hatmap(const Eigen::Vector3d &v) {
  Eigen::Matrix3d H;
  H <<     0.0, -v.z(),  v.y(),
        v.z(),    0.0, -v.x(),
       -v.y(),  v.x(),    0.0;
...
Eigen::Matrix3d ControllerMrsNetFreeEnds::so3transform(const Eigen::Vector3d& body_z, const ::Eigen::Vector3d& heading, const bool& preserve_heading) {
...
double ControllerMrsNetFreeEnds::calculateGainChange(const double dt, const double current_value, const double desired_value, const bool bypass_rate, std::string name,
                                          bool& updated) {
  ...
  if (std::abs(change) > 1e-3) {
    ROS_DEBUG("[ControllerMrsNetFreeEnds]: changing gain '%s' from %.2f to %.2f", name.c_str(), current_value, desired_value);
    updated = true;
  }
...
double ControllerMrsNetFreeEnds::getHeadingSafely(const mrs_msgs::UavState& uav_state, const mrs_msgs::TrackerCommand& tracker_command) {
...
// void ControllerMrsNetFreeEnds::Publisher_QuadState(const mrs_msgs::UavState& uav_state){
...
// void ControllerMrsNetFreeEnds::timerPublishQuadState([[maybe_unused]] const ros::TimerEvent& te, const mrs_msgs::UavState& uav_state) {
...
PLUGINLIB_EXPORT_CLASS(pratik_controller_mrs_net_free_ends::controller_mrs_net_free_ends::ControllerMrsNetFreeEnds, mrs_uav_managers::Controller)
